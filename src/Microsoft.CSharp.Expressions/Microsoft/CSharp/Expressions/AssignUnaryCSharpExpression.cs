...
namespace Microsoft.CSharp.Expressions
{
    ...
    public abstract partial class AssignUnaryCSharpExpression : UnaryCSharpExpression
    {
        ...
        public override Expression Reduce()
        {
            ...
            else if (IsCSharpSpecificUnaryAssignNumeric(operandType) || IsCheckedUnary)
            {
                ...
                var intermediateType = nonNullOperandType.GetTypeInfo().IsEnum ? nonNullOperandType.GetEnumUnderlyingType() : typeof(int);
    ...
    partial class CSharpExpression
    {
        ...
        {
            ExpressionUtils.RequiresCanRead(operand, nameof(operand));
