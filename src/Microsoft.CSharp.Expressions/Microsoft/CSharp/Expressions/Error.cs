...
namespace Microsoft.CSharp.Expressions
{
    ...
    internal static partial class Error
    {
        ...
        /// </summary>
        internal static Exception TupleComponentCountMismatch(object p0, object p1)
        {
            return new ArgumentException(Strings.TupleComponentCountMismatch(p0, p1));
        }

        /// <summary>
        /// ArgumentException with message like "The number of element conversion expressions does not match tuple arity '{0}'."
        /// </summary>
        internal static Exception InvalidElementConversionCount(object p0)
        {
        ...
        public static Exception TypeIsGeneric(Type type, string? paramName, in int index)
        {
            throw new ArgumentException("TypeIsGeneric", paramName);
        }

        public static Exception TypeContainsGenericParameters(Type type, string? paramName, in int index)
        {
            throw new Exception($"{nameof(TypeContainsGenericParameters)} - {type} - {paramName} - {index}");
        }

        public static Exception IncorrectNumberOfConstructorArguments()
        {
            throw new Exception(nameof(IncorrectNumberOfConstructorArguments));
        }

        public static Exception IncorrectNumberOfLambdaArguments()
        {
            throw new Exception(nameof(IncorrectNumberOfLambdaArguments));
        }

        public static Exception IncorrectNumberOfMethodCallArguments(MethodBase method, string methodName)
        {
            throw new Exception($"{nameof(IncorrectNumberOfMethodCallArguments)} - {methodName}");
        }

        public static Exception InvalidLvalue(ExpressionType leftNodeType)
        {
            throw new Exception(nameof(InvalidLvalue));
        }

        public static Exception UnhandledBinding()
        {
            throw new Exception(nameof(UnhandledBinding));
        }

        public static Exception CannotAutoInitializeValueTypeMemberThroughProperty(MemberInfo bindingMember)
        {
            throw new Exception(nameof(CannotAutoInitializeValueTypeMemberThroughProperty));
        }

        public static Exception CannotAutoInitializeValueTypeElementThroughProperty(MemberInfo bindingMember)
        {
            throw new Exception(nameof(CannotAutoInitializeValueTypeElementThroughProperty));
        }

        public static Exception InvalidArgumentValue(string paramName)
        {
            throw new ArgumentException(nameof(InvalidArgumentValue), paramName);
        }

        public static Exception NonEmptyCollectionRequired(string paramName)
        {
            throw new ArgumentException(nameof(NonEmptyCollectionRequired), paramName);
        }

        public static Exception ExpressionTypeDoesNotMatchConstructorParameter(Type argumentsType, Type pType, string argumentParamName, int index)
        {
            throw new Exception($"{nameof(ExpressionTypeDoesNotMatchConstructorParameter)} - {pType} - {argumentParamName} - {index}");
        }

        public static Exception ExpressionTypeDoesNotMatchParameter(Type argumentsType, Type pType, string argumentParamName, int index)
        {
            throw new Exception($"{nameof(ExpressionTypeDoesNotMatchParameter)} - {pType} - {argumentParamName} - {index}");
        }

        public static Exception ExpressionTypeDoesNotMatchMethodParameter(Type argumentsType, Type pType, MethodBase method, string argumentParamName, int index)
        {
            throw new Exception($"{nameof(ExpressionTypeDoesNotMatchMethodParameter)} - {pType} - {argumentsType} - {argumentParamName} - {index}");
        }

        public static Exception ExpressionMustBeReadable(string paramName, int idx)
        {
            throw new Exception($"{nameof(ExpressionMustBeReadable)} - {paramName} - {idx}");
        }
    }
    ...
    internal static partial class Strings
    {
        ...
        /// </summary>
        internal static string TupleComponentCountMismatch(object p0, object p1)
        {
            return SR.Format(SR.TupleComponentCountMismatch, p0, p1);
        }

        /// <summary>
        /// A string like "The number of element conversion expressions does not match tuple arity '{0}'."
        /// </summary>
        internal static string InvalidElementConversionCount(object p0)
        {
