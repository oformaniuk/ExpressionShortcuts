...
namespace Microsoft.CSharp.Expressions
{
    ...
    public abstract partial class ForEachCSharpStatement : LoopCSharpStatement
    {
        ...
        internal static ForEachCSharpStatement Make(ParameterExpression variable, Expression collection, Expression body, LabelTarget breakLabel, LabelTarget continueLabel, LambdaExpression conversion)
        {
            ...
            var getEnumeratorMethod = collectionType.GetNonGenericMethod("GetEnumerator", BindingFlags.Public | BindingFlags.Instance, ArrayEx.Empty<Type>());
            if (getEnumeratorMethod != null)
            {
                ...
                var moveNextMethod = enumeratorType.GetNonGenericMethod("MoveNext", BindingFlags.Public | BindingFlags.Instance, ArrayEx.Empty<Type>());
