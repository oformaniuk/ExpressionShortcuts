...
namespace Microsoft.CSharp.Expressions
{
    partial class CSharpExpression
    {
        ...
        public static ElementInit IndexInit(MethodInfo indexer, IEnumerable<Expression> arguments, Expression value)
        {
            ...
            var property = indexer.DeclaringType.GetTypeInfo().GetProperties(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).First(o => o.GetMethod == indexer);
            
            return IndexInit(property, arguments, value);
        }
        ...
        public static ElementInit IndexInit(PropertyInfo indexer, IEnumerable<Expression> arguments, Expression value)
        {
            ...
            //ExpressionUtils.RequiresCanRead(argList, nameof(arguments));
            ...
            ExpressionUtils.ValidateArgumentTypes(setter, ExpressionType.Call, ref argList, nameof(setter));
