...
namespace Microsoft.CSharp.Expressions
{
    ...
    partial class CSharpExpression
    {
        ...
        {
            ExpressionUtils.RequiresCanRead(receiver, nameof(receiver));
            RequiresNotNull(nonNullReceiver, nameof(nonNullReceiver));
            ExpressionUtils.RequiresCanRead(whenNotNull, nameof(whenNotNull));

            var receiverType = receiver.Type;
            if (receiverType == typeof(void) || receiverType.IsByRef || (receiverType.GetTypeInfo().IsValueType && !receiverType.IsNullableType()))
            {
