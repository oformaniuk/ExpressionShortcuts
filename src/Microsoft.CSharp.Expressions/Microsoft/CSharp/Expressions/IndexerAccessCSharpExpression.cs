...
namespace Microsoft.CSharp.Expressions
{
    ...
    partial class CSharpExpression
    {
        ...
        {
            var property = lengthOrCount != null ? lengthOrCount.GetProperty() : null;
        ...
        public static IndexerAccessCSharpExpression IndexerAccess(Expression @object, Expression argument, PropertyInfo lengthOrCount, MemberInfo indexOrSlice)
        {
            ...
            if (argument.Type == typeof(Index))
            {
                ...
                var methodInfo = indexOrSlice as MethodInfo ?? throw Error.InvalidIndexMember(indexOrSlice);
                var index = indexOrSlice as PropertyInfo ?? methodInfo.GetProperty();
