...
namespace Microsoft.CSharp.Expressions
{
    ...
    partial class CSharpExpression
    {
        ...
        {
            ExpressionUtils.RequiresCanRead(resource, nameof(resource));
            ...
            if (variable != null)
            {
                ...
                TypeUtils.ValidateType(variableType, variable.Name);
                TypeUtils.ValidateType(resourceType, nameof(resource));
                ...
                if (!TypeUtils.AreReferenceAssignable(variableType, resourceType))
                {
