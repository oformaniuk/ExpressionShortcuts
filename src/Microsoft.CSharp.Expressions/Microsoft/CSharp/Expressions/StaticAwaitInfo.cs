...
namespace Microsoft.CSharp.Expressions
{
    ...
    partial class CSharpExpression
    {
        ...
        public static StaticAwaitInfo AwaitInfo(LambdaExpression getAwaiter, MethodInfo isCompleted, MethodInfo getResult)
        {
            ...
            var propertyInfo = isCompleted.DeclaringType.GetTypeInfo().GetProperties(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).First(o => o.GetMethod == isCompleted);

            return AwaitInfo(getAwaiter, propertyInfo, getResult);
        }
        ...
        private static void ResolveAwaiterInfo(Type awaiterType, ref PropertyInfo isCompleted, ref MethodInfo getResult)
        {
            ...
            getResult ??= awaiterType.GetNonGenericMethod("GetResult", BindingFlags.Public | BindingFlags.Instance, ArrayEx.Empty<Type>());
        }

        internal static MethodInfo GetGetAwaiter(Type awaiterType)
        {
            return awaiterType.GetNonGenericMethod("GetAwaiter", BindingFlags.Public | BindingFlags.Instance, ArrayEx.Empty<Type>());
        }
